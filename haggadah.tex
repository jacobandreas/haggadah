...
\begin{HgEnglish}
  ...
  who creates the fruit of the vine.
\end{HgEnglish}
\HgInst{Drink the third cup, and pour the fourth.}
...
\begin{HgEnglish}
  A song of ascents: When God brought the exiles back to Zion, we were like
  dreamers.  Then our mouths were filled with laughter and our tongues with
  song. Then it was said among the nations: ``God has done great things for
  them.'' God has done great things for us, and we rejoiced. Return us, God,
  from our exile, like streams to the desert. The ones who sow in tears will
  reap in joy; the ones who go out weeping, carrying sacks of seeds, will return
  in joy, bearing sheaves of wheat.
...
\begin{HgEnglish}
  ...
  \HgSource{Psalm 79:6-7} \\
  Pour out thine indignation upon them, \\
  And let thy wrathful anger take hold of them. 
  
  \HgSource{Psalm 69:24} \\
